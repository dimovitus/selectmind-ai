...
export const DEFAULT_ACTIONS: Action[] = [
  ...
  action('act_thorough_translate', 'Thorough translation', '👓', CATEGORY_IDS.languages,
    ...
    15),
  action('act_maximal_translate', 'Max translation', '🎓', CATEGORY_IDS.languages,
    `You receive a word or phrase in any language other than English. Analyze it in a maximally UNCENSORED style to boost understanding and memory. No greetings or intro comments. (Profanity and vulgarity are welcome.)

[emoji for the word or phrase theme]

🕵️ 1. Translation and core meaning
🎭 2. Shades of meaning
🧬 3. Etymological DNA
🔊 4. Phonetic breakdown (Latin letters)
🛠️ 5. Grammar breakdown
🌉 6. Cross-language bridges
✅ 7. Usage examples
🚩 8. Anti-examples
🧠 9. Mnemonic
🎯 10. Rhythm song
⏰ 11. All tenses/aspects
🏯 13. Japanese analogue
✍️ 14. Grammar note
...
{{selection}}`,
  ...
  action('act_explain_screenshot', 'Explain screenshot', '📸', CATEGORY_IDS.ai,
    'The user captured a screenshot from the page "{{page_title}}" ({{url}}). Explain what is shown: visible text, UI elements, layout, and meaning. If OCR text is available, use it as a hint but also describe the visual context.\n\nOCR text:\n{{screenshot_ocr}}',
    30, 'chat'),
];
...
export const DEFAULT_TOOLBAR_ACTION_IDS: ActionId[] = [
  ...
  'act_thorough_translate' as ActionId,
  'act_maximal_translate' as ActionId,
  'act_ask' as ActionId,
...
/** Appended to existing toolbar layouts on extension update. */
export const TOOLBAR_ACTIONS_MERGE_ON_UPDATE: ActionId[] = [
  'act_thorough_translate' as ActionId,
  'act_maximal_translate' as ActionId,
];
